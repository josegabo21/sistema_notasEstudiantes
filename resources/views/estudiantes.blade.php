...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Panel - Representante</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-5 mb-4"> <!-- Cambia el tamaño de la columna según sea necesario -->
            ...
            </div> <!-- Fin de la columna para cada estudiante -->
        @endforeach
    </div> <!-- Fin de la fila -->
