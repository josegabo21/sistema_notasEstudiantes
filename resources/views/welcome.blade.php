...
<head>
  ...
  <title>SchoolMAnager | Log in</title>
...
<body class="hold-transition login-page" style="background-image: url('/AdminLTE/dist/img/fondo_de_pantalla.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; height: 100vh;">
<div class="login-box">
  <div class="login-logo">
 
    <img src="/AdminLTE/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .9">
  </div>
  <!-- /.login-logo -->
