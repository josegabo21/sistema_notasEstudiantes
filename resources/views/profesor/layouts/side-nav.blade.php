...
<nav class="main-header navbar navbar-expand-md navbar-white">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="d-flex justify-content-between w-100 me-4">
                ...
                <div class="d-flex align-items-center">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                          <a href="{{ route('profesor.dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                              <p>
                                  Inicio               
                              </p>
                          </a>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profesor.profile.edit')">
                            {{ __('Perfil') }}
                        </x-dropdown-link>
    ...
    <div class="pt-4 pb-1 border-t border-gray-200">
        ...
        <div class="mt-3 space-y-1">
            <x-responsive-nav-link :href="route('profesor.profile.edit')">
                {{ __('Perfil') }}
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3">
        <div class="image">
        <img src="{{ asset('images/' . Auth::user()->foto) }}" class="img-circle elevation-2" alt="User Image" style="width: 40px; hight: 40px;">
        </div>
        <div class="info">
      ...
      <div class="form-inline">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
          <li class="nav-item">
              <x-side :href="route('profesor.calificar.tablaBoletin')" :active="request()->routeIs('profesor.calificar.tablaBoletin')" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
