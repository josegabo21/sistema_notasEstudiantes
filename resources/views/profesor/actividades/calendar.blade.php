...
<head>
  ...
  <title>StudyChard | Cronograma</title>
  ...
  <link href="{{asset('AdminLTE/dist/css/bootstrap.min.css')}}" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
</head>
      ...
      <div class="container-fluid">
        ...
        <div class="row row-cols-2 mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"> <x-nav-link :href="route('dashboard')">
                      {{ __('Inicio') }}
                    </x-nav-link></li>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    <div class="external-event bg-success">Clase del jueves</div>
...
<script src="{{asset('AdminLTE/plugins/fullcalendar/locales/es.js')}}"></script>
