    ...
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-floating mb-3">
            <textarea class="form-control" id="description" rows="3" name="description" style="height: 100px" placeholder="description" required></textarea>
            <label for="description" class="form-label" >Descripci&oacuten</label>
          </div>
          <div class="mb-3">
            <select class="form-select form-select-sm" aria-label="Small select example" id="type" name="type" required>
          ...
          <div class="form-floating mb-3">
            <input type="datetime-local" class="form-control" id="end" rows="3" name="end" required>
          ...
          <div class="mb-3">
            ...
            <input type="color" class="form-control form-control-color" id="backgroundColor" value="#563d7c" title="Elige el color" name="backgroundColor" required>
          </div>
        </div>
