  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lista estudiantes {{ $grado }}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="bg-white p-3 rounded">
        <div style="overflow-x: auto;">
            ...
            <button class="btn btn-success mb-3" onclick="generatePDF()">Generar PDF</button>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center flex justify-center items-center">
                            <a href="{{ route('admin.grades.boletin.show', $student->id) }}">
...
function generatePDF() {
        ...
        // Ocultar las columnas de Fecha de Nacimiento (índice 4), Dirección (índice 6) y Momentos (índice 8)
        for (let i = 0; i < rows.length; i++) {
            ...
            if (rows[i].cells.length > 8) {
                rows[i].cells[8].style.display = 'none'; // Momentos
            }
        }
        ...
        const opt = {
            margin: 1,
            filename: 'reporte_estudiantes {{ $grado }}.pdf',
        ...
        html2pdf()
            ...
            .then(() => {
                ...
                for (let i = 0; i < rows.length; i++) {
                    ...
                    if (rows[i].cells.length > 8) {
                        rows[i].cells[8].style.display = ''; // Momentos
                    }
                }
            });
    }
