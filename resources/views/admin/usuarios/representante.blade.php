                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form id="delete-form-{{ $user->id }}" action="{{ route('admin.usuarios.representante.destroy', $user->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <div class="d-flex justify-content-center" style="white-space: nowrap;">
                                                <button class="btn btn-danger" type="button" onclick="confirmDelete({{ $user->id }})">Eliminar Representante</button>
                                                </div>
                                            </form>
                                        </td>  
                                        </tr>
